...
export = _exports;
type Util = import("config/lib/util").Util;
type Load = import("config/lib/util").Load;
type LoadOptions = import("config/lib/util").LoadOptions;
type Parser = typeof import("config/parser");
/**
...
declare class ConfigUtils {
     ...
     */
    getConfigSources(): import("config/lib/util").ConfigSource[];
    /**
